...
#This section was partially programmed with the help of ChatGPT-4
#specially section 11
...
# 2. LOAD DATA
# -----------------------------------------------
features_df <- read_csv(here::here("Data", "training_set_features.csv"))
labels_df <- read_csv(here::here("Data", "training_set_labels.csv"))
...
```{r generate-plots, include=FALSE}
#------------------------------
...
vaccination_rate_plot <- function(col, target, data, title = NULL, thresh = 10) {
  ...
  if (is.factor(data[[col]]) ||
    ...
    # Need to make sure we preserve the actual levels present in the data
...
# Create & display your grid of H1N1 vs seasonal plots
h1n1_plots     <- list()
seasonal_plots <- list()
...
# Here you can just pick a feature we are interested in looking
#Since h1n1_plots is list
h1n1_list_plots <- (h1n1_plots$h1n1_concern + ggtitle("H1N1 Vaccination Rate by H1N1 Concern") +
                      h1n1_plots$h1n1_knowledge + ggtitle("H1N1 Vaccination Rate by H1N1 Knowledge")) /
...
```{r h1n1-plots, echo = FALSE, fig.width = 11}
# H1N1 Vaccine related plots
h1n1_list_plots
```



```{r seasonal-plots, echo = FALSE, fig.width = 12}
# Seasonal Vaccine related plots
seasonal_list_plots
```
