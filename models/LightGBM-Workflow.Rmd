...
lgbm_h1n1_dt_wkfl_fit <- readRDS(
  here("utils", "lightgbm-rds", "section8_lgbm_h1n1_dt_wkfl_fit.rds")
)

lgbm_seas_dt_wkfl_fit <- readRDS(
  here("utils", "lightgbm-rds", "section8_lgbm_seas_dt_wkfl_fit.rds")
)
```
...
#Option in case of quick result
lgbm_h1n1_dt_rs <- readRDS(
  here("utils", "lightgbm-rds", "section10_lgbm_h1n1_dt_rs.rds")
)

lgbm_seasonal_dt_rs <- readRDS(
  here("utils", "lightgbm-rds", "section10_lgbm_seasonal_dt_rs.rds")
)
...
#Option in case of quick results
lgbm_h1n1_dt_tuning <- readRDS(
  here("utils", "lightgbm-rds", "section11_lgbm_h1n1_dt_tuning.rds")
)

lgbm_seas_dt_tuning <- readRDS(
  here("utils", "lightgbm-rds", "section11_lgbm_seas_dt_tuning.rds")
)
```
