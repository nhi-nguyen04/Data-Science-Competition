...
# -----------------------------------------------
# For server environments, please comment out lines 20-40 to prevent unnecessary package installation.
...
rf_h1n1_dt_wkfl_fit <- readRDS(
  here("utils", "random-forest-rds", "section8_rf_h1n1_dt_wkfl_fit.rds")
)

rf_seas_dt_wkfl_fit <- readRDS(
  here("utils", "random-forest-rds", "section8_rf_seas_dt_wkfl_fit.rds")
)
```
...
#Option in case of quick results
rf_h1n1_dt_rs <- readRDS(
  here("utils", "random-forest-rds", "section10_rf_h1n1_dt_rs.rds")
)

rf_seasonal_dt_rs <- readRDS(
  here("utils", "random-forest-rds", "section10_rf_seasonal_dt_rs.rds")
)
...
#Option in case of quick results
rf_h1n1_dt_tuning <- readRDS(
  here("utils", "random-forest-rds", "section11_rf_h1n1_dt_tuning.rds")
)

rf_seas_dt_tuning <- readRDS(
  here("utils", "random-forest-rds", "section11_rf_seas_dt_tuning.rds")
)
```
