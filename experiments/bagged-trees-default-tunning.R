...
# -----------------------------------------------
# 6. R E C I P E ––  (Tree-based models)
# -----------------------------------------------
...
#Tune bagged trees trained with entire training dataset
bt_h1n1_final_fit <- 
  bt_final_h1n1_tune_wkfl %>% 
  last_fit(split = data_split_h1n1)
...
# -----------------------------------------------
#Already availabe
#write_csv(submission_bagged_tree, "bagged_tree_default-tunning-grid-100.csv")
