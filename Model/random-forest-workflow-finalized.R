...
test_pred_h1n1_random_forest <- predict(final_h1n1, test_df_prepared, type = "prob") %>% pull(.pred_1)
test_pred_seas_random_forest <- predict(final_seas, test_df_prepared, type = "prob") %>% pull(.pred_1)
